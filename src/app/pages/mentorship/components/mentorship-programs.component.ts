  ...
  template: `
    <section class="py-16 bg-gray-50">
      <div class="max-w-7xl mx-auto px-4">
        <h2 class="text-3xl font-bold mb-12 text-center">Our Training Programs</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div class="bg-white p-6 rounded-lg shadow-md">
            <h3 class="text-xl font-semibold mb-4">Specialized Materials</h3>
            <p class="text-gray-600">Access curated learning materials to grow and scale just right. </p>
          </div>
        </div>
      </div>
    </section>
