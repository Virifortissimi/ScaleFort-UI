      ...
      <section class="relative min-h-[500px] bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-center overflow-visible">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 pt-24 md:pt-32 pb-20">
          ...
          <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in [animation-delay:200ms]">
            Modern Frontend Development <br class="hidden md:block" />
            with <span class="bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-blue-300"> JavaScript and React</span>
          </h1>
          
          <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-8 animate-fade-in [animation-delay:400ms]">
            Master cutting-edge frontend development skills using the latest technologies and frameworks.
          </p>
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in [animation-delay:600ms]">
            ...
            <a href="/courses/frontend#outline" class="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-xl font-semibold hover:bg-white/20 transition-all transform hover:-translate-y-1">
              View Curriculum
              <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <nav class="w-full md:w-auto">
              <ul class="flex flex-wrap gap-4 md:gap-6">
                <li *ngFor="let section of sections" class="group relative overflow-hidden rounded-lg">
                  <a 
                    [href]="'/courses/frontend#' + section.id"
          ...
          <div id="overview" class="mb-16 scroll-mt-32">
            ...
            <div class="text-center mb-12">
              ...
              <p class="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
                Become a proficient frontend developer mastering modern JavaScript, React, and cutting-edge tools. Learn to build responsive, accessible, and high-performance web applications.
              </p>
            </div>
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                  ...
                  <ul class="space-y-4">
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Modern JavaScript (ES6+)</h4>
                        <p class="text-sm text-gray-600 mt-1">Master core JavaScript concepts and syntax</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">React & Next.js Framework</h4>
                        <p class="text-sm text-gray-600 mt-1">Build robust web applications with React and Next.js</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">State Management</h4>
                        <p class="text-sm text-gray-600 mt-1">Learn state management techniques with Redux and Context API</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Responsive Web Design</h4>
                        <p class="text-sm text-gray-600 mt-1">Create responsive and visually appealing web applications</p>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                ...
                <ul class="space-y-5">
                  ...
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    <div class="w-2 h-2 bg-blue-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">API Integration Specialist</h4>
