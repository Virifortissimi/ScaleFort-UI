      ...
      <section class="relative min-h-[500px] bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-center overflow-visible">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 pt-24 md:pt-32 pb-20">
          ...
          <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in [animation-delay:200ms]">
            Cloud Computing <br class="hidden md:block" />
            & <span class="bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-blue-300"> DevOps</span>
          </h1>
          
          <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-8 animate-fade-in [animation-delay:400ms]">
            Master cloud infrastructure, deployment, and management with industry best practices.
          </p>
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in [animation-delay:600ms]">
            ...
            <a href="/courses/cloud-computing#outline" class="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-xl font-semibold hover:bg-white/20 transition-all transform hover:-translate-y-1">
              View Curriculum
              <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                  ...
                  <ul class="space-y-4">
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Cloud Infrastructure Design</h4>
                        <p class="text-sm text-gray-600 mt-1">Master core cloud concepts and services</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">CI/CD Pipelines</h4>
                        <p class="text-sm text-gray-600 mt-1">Implement CI/CD pipelines using Jenkins and GitHub Actions</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Container Orchestration</h4>
                        <p class="text-sm text-gray-600 mt-1">Manage containerized applications with Kubernetes</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Infrastructure as Code</h4>
                        <p class="text-sm text-gray-600 mt-1">Create and manage cloud resources using Terraform</p>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                ...
                <ul class="space-y-5">
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    ...
                    <div>
                      <h4 class="font-medium text-gray-900">Cloud Engineer</h4>
                  ...
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    <div class="w-2 h-2 bg-blue-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">DevOps Specialist</h4>
                  ...
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    <div class="w-2 h-2 bg-blue-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">Site Reliability Engineer</h4>
                  ...
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    <div class="w-2 h-2 bg-blue-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">Solutions Architect</h4>
