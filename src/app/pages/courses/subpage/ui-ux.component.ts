      ...
      <section class="relative min-h-[500px] bg-gradient-to-br from-purple-900 via-blue-900 to-indigo-900 text-center overflow-visible">
        ...
        <div class="relative z-10 max-w-7xl mx-auto px-4 pt-24 md:pt-32 pb-20">
          ...
          <h1 class="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-6 leading-tight animate-fade-in [animation-delay:200ms]">
            UI/UX Design Mastery <br class="hidden md:block" />
            with <span class="bg-clip-text text-transparent bg-gradient-to-r from-purple-300 to-blue-300"> Figma</span>
          </h1>
          
          <p class="text-xl md:text-2xl text-blue-100 max-w-3xl mx-auto leading-relaxed mb-8 animate-fade-in [animation-delay:400ms]">
            Master Figma and Adobe XD to create stunning user interfaces and experiences.
          </p>
          ...
          <div class="flex flex-col sm:flex-row gap-4 justify-center items-center animate-fade-in [animation-delay:600ms]">
            ...
            <a href="/courses/ui-ux-design#outline" class="inline-flex items-center justify-center px-8 py-4 bg-white/10 backdrop-blur-sm border border-white/20 text-white rounded-xl font-semibold hover:bg-white/20 transition-all transform hover:-translate-y-1">
              View Curriculum
              <svg class="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <div class="flex flex-col md:flex-row justify-between items-center py-4 space-y-6 md:space-y-0 bg-white/70 backdrop-blur-md shadow-md rounded-2xl px-6">
            ...
            <nav class="w-full md:w-auto">
              <ul class="flex flex-wrap gap-4 md:gap-6">
                <!-- Why is the UI not seeing the sections? -->
                ...
                >
                  <a 
                    [href]="'/courses/ui-ux-design#' + section.id"
                ...
                <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
                  ...
                  <ul class="space-y-4">
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">User Research & Personas</h4>
                        <p class="text-sm text-gray-600 mt-1">Master user research techniques and create effective personas</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Wireframing & Prototyping</h4>
                        <p class="text-sm text-gray-600 mt-1">Learn to create wireframes and prototypes for user testing</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Interaction Design</h4>
                        <p class="text-sm text-gray-600 mt-1">Learn to create user-centered designs through research and prototyping</p>
                      </div>
                    </li>
                    <li class="flex items-start p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                      <svg class="w-5 h-5 text-green-600 mt-0.5 mr-3 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      ...
                      <div>
                        <h4 class="font-medium text-gray-900">Usability Testing</h4>
                        <p class="text-sm text-gray-600 mt-1">Learn to conduct usability tests and gather user feedback</p>
                      </div>
                    </li>
                  </ul>
                </div>
              ...
              <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                ...
                <ul class="space-y-5">
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    ...
                    <div>
                      <h4 class="font-medium text-gray-900">UI Designer</h4>
                  ...
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    <div class="w-2 h-2 bg-blue-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">UX Researcher</h4>
                  ...
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    <div class="w-2 h-2 bg-blue-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">Product Designer</h4>
                  ...
                  <li class="flex items-center p-3 bg-blue-50/50 rounded-lg group hover:bg-blue-100 transition-colors">
                    <div class="w-2 h-2 bg-blue-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">Interaction Designer</h4>
              ...
              <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 transform hover:-translate-y-1">
                ...
                <ul class="space-y-5">
                  ...
                  <li class="flex items-center p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                    <div class="w-2 h-2 bg-green-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">Design Challenges</h4>
                      <p class="text-sm text-gray-600">Mock design challenges</p>
                    </div>
                  </li>
                  <li class="flex items-center p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                    <div class="w-2 h-2 bg-green-500 rounded-full mr-4 flex-shrink-0"></div>
                    <div>
                      <h4 class="font-medium text-gray-900">Case study development</h4>
                      <p class="text-sm text-gray-600">Build a comprehensive case study</p>
                    </div>
                  </li>
                  <li class="flex items-center p-3 bg-green-50/50 rounded-lg group hover:bg-green-100 transition-colors">
                    <div class="w-2 h-2 bg-green-500 rounded-full mr-4 flex-shrink-0"></div>
