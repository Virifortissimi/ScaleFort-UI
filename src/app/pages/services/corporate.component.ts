    ...
    <div>
      ...
      <section class="relative min-h-[80vh] bg-gradient-to-r from-purple-900 via-purple-800 to-purple-900 text-white overflow-hidden flex items-center">
        <div class="absolute inset-0">
          <div class="absolute w-96 h-96 bg-purple-500/20 rounded-full blur-3xl animate-blob1"></div>
        ...
        <div class="max-w-7xl mx-auto px-4 relative z-10 py-24">
          <div class="max-w-3xl animate-fade-in">
            ...
            <p class="text-xl mb-8 text-purple-100 animate-slide-up" style="animation-delay: 400ms">
              Transform your organization's capabilities with tailored training solutions aligned with your business objectives.
            </p>
        ...
        <div class="max-w-7xl mx-auto px-4 relative">
          <div class="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div class="space-y-8 animate-on-scroll">
              <div class="inline-block px-4 py-1 rounded-full bg-purple-50 text-purple-600 font-medium">
                Our Approach
              </div>
              ...
              <p class="text-gray-600 text-lg leading-relaxed">
                We design training programs that directly contribute to your organizational KPIs through:
              </p>
              <ul class="space-y-4">
                <li class="flex items-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all transform hover:-translate-y-1">
                  <div class="w-12 h-12 bg-purple-50 rounded-full flex items-center justify-center mr-4">
                    <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6V4m0 2a2 2 0 100 4m0-4a2 2 0 110 4m-6 8a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4m6 6v10m6-2a2 2 0 100-4m0 4a2 2 0 110-4m0 4v2m0-6V4" />
                    </svg>
                  </div>
                  <span class="text-gray-700">Skills gap analysis & needs assessment</span>
                </li>
                <li class="flex items-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all transform hover:-translate-y-1">
                  <div class="w-12 h-12 bg-purple-50 rounded-full flex items-center justify-center mr-4">
                    <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span class="text-gray-700">Custom curriculum development</span>
                </li>
                <li class="flex items-center p-4 bg-white rounded-xl shadow-sm hover:shadow-md transition-all transform hover:-translate-y-1">
                  <div class="w-12 h-12 bg-purple-50 rounded-full flex items-center justify-center mr-4">
                    <svg class="w-6 h-6 text-purple-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <span class="text-gray-700">ROI-focused learning outcomes</span>
                </li>
              </ul>
            </div>
            <div class="relative aspect-video group animate-on-scroll">
              <div class="absolute inset-0 bg-gradient-to-r from-purple-600 to-indigo-600 rounded-2xl transform group-hover:scale-95 transition-all duration-500"></div>
              <img src="assets/corporate-training-process.jpg" 
      ...
      <section class="py-32 bg-gray-50 relative overflow-hidden">
        <div class="max-w-7xl mx-auto px-4 relative">
          <div class="text-center max-w-3xl mx-auto mb-16 animate-on-scroll">
            <div class="inline-block px-4 py-1 rounded-full bg-purple-50 text-purple-600 font-medium mb-4">
              Training Programs
            </div>
            <h2 class="text-4xl font-bold mb-6">Comprehensive Learning Solutions</h2>
            ...
            <div *ngFor="let program of programs; let i = index" 
              ...
              <div class="relative overflow-hidden">
                ...
                <div class="absolute bottom-4 left-4 text-white">
                  <span class="px-3 py-1 bg-purple-600 rounded-full text-sm font-medium">
                    {{ program.category }}
                  </span>
                </div>
              </div>
              <div class="p-8">
                <h3 class="text-2xl font-bold mb-3 group-hover:text-purple-600 transition-colors">
                  {{ program.title }}
                </h3>
                ...
                <a routerLink="/contact" 
                   class="inline-flex items-center px-6 py-3 bg-purple-50 text-purple-600 rounded-full font-semibold group-hover:bg-purple-600 group-hover:text-white transition-all duration-300">
                  Customize Program
      ...
      <section class="py-32 bg-white">
        <div class="max-w-7xl mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 animate-on-scroll">
            <div class="p-6 text-center bg-gray-50 rounded-2xl hover:shadow-lg transition-all">
              ...
              <p class="text-gray-600">Comprehensive skills gap analysis and competency mapping</p>
            </div>
            <div class="p-6 text-center bg-gray-50 rounded-2xl hover:shadow-lg transition-all">
              <div class="w-16 h-16 bg-purple-600 text-white rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p class="text-gray-600">Tailored learning paths aligned with business objectives</p>
            </div>
            <div class="p-6 text-center bg-gray-50 rounded-2xl hover:shadow-lg transition-all">
              <div class="w-16 h-16 bg-purple-600 text-white rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p class="text-gray-600">Mix of workshops, e-learning, and hands-on projects</p>
            </div>
            <div class="p-6 text-center bg-gray-50 rounded-2xl hover:shadow-lg transition-all">
              <div class="w-16 h-16 bg-purple-600 text-white rounded-full flex items-center justify-center mx-auto mb-4">
                <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              ...
              <p class="text-gray-600">ROI tracking and competency-based assessments</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <!-- CTA Section -->
      <section class="py-32 bg-gradient-to-r from-purple-600 to-indigo-600 text-white relative overflow-hidden">
        <div class="absolute inset-0">
        ...
        <div class="max-w-4xl mx-auto px-4 text-center relative z-10 animate-on-scroll">
          <h2 class="text-3xl md:text-4xl font-bold mb-4">Ready to Upskill Your Team?</h2>
          <p class="text-lg md:text-xl mb-6">
            Let's create a custom learning program that drives measurable business results
          </p>
          <a href="/contact" 
        ...
        <div class="max-w-7xl mx-auto px-4">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 animate-on-scroll">
            <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all">
              ...
              <p class="text-gray-600 italic">"The customized cloud training program reduced our deployment errors by 60%"</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all">
              ...
              <p class="text-gray-600 italic">"Our development team's efficiency doubled after the agile training"</p>
            </div>
            ...
            <div class="bg-white p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all">
              ...
              <p class="text-gray-600 italic">"90% of our engineers achieved AWS certification after the training program"</p>
            </div>
          </div>
        </div>
      </section>
  ...
  programs = [
    {
      ...
      description: 'Modern software development practices and cloud technologies',
      duration: '4-12 Weeks',
    ...
    },
    {
      ...
      description: 'For tech leaders managing distributed teams and digital transformation',
      duration: '8 Weeks',
    ...
    },
    {
      ...
      image: 'https://images.unsplash.com/photo-1579389083078-4e7018379f7e?ixlib=rb-4.0.3',
      description: 'Implement agile practices across engineering and business teams',
      duration: '6 Weeks',
